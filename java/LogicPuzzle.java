...
public class LogicPuzzle extends AppCompatActivity {
    private ArrayList<Player> playerList;
    private ArrayList<Riddle> logPuzz;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logPuzz = new ArrayList<Riddle>();
        for(int i = 0; i < riddles.size(); i ++)
        {
            if(riddles.get(i).getCategory()==3)
            {
                logPuzz.add(riddles.remove(i));
            }
        }
    ...
    public void newRiddle(){
        ...
        int tempCount = (int )(Math.random() * logPuzz.size());
        currentRiddle = logPuzz.remove(tempCount);
    ...
    public void nextCategory(){
        Intent creditIntent = new Intent(LogicPuzzle.this,Credits.class);
        Bundle b = new Bundle();
        b.putParcelableArrayList("PlayerList", playerList);
        creditIntent.putExtras(b);
